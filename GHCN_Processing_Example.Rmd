---
title: "NCEI GHCN Processing Example"
output:
...
Technical Note Found [here](https://www.unidata.ucar.edu/mailing_lists/archives/netcdfgroup/2017/msg00143.html)

According to one developer, [this](https://gist.github.com/mdsumner/733fb5520b417869f37cc88118cc429f#file-opendap-ncdf4-windows-txt) works but I have not tried it.  

If this doesn't work you will need to download the netcdf file(s) from our university [THREDDS](http://kyrill.ias.sdsmt.edu:8080/thredds/catalog.html) Server
...
Here we use one of the ncdf4.helper functions, [nc.get.time.series](https://www.rdocumentation.org/packages/ncdf4.helpers/versions/0.3-3/topics/nc.get.time.series).
...
We first crete a data frame and then populate it.
